...
* [Version: 0.9.77 (2020-07-??)](#version-0977-2020-07-)
 ...
 * apache service changes:
    ...
    * added `local.d` directory for file that are generated
 * apt service change:
 ...
 * node\_exporter, nvidia\_gpu\_prometheus\_exporter change:
    * delete initrd file when  systemd class is true
 * pam service change:
 ...
 * slurm service changes:
    * plugstack.conf is now also generated by mustache
    * Added default for gid/uid: 555
    * All dir variables re now set a json file so we can support package/tarball installations
