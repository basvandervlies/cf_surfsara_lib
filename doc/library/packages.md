...
This will install the `openssh-server` package and override the package definitions in the service
bundle ssh. The `[version]` can be empty `""`. It will install any version of the package.
 ...
 * purge: delete the package and all it configuration files (Debian)
